...
beforeEach(()=>{
 ...
 config={gateway:{api:{keys:[{id:'owner',key:'admin-fixture',admin:true,agents:'*'},{id:'other',key:'other-fixture',admin:true,agents:'*'},{id:'readonly',key:'reader-fixture',agents:'*'}]},jev:{enabled:true,provider:'typesafe',model:'jev',features:{browserTasks:{enabled:true}},browser:{runnerModule:'@example/runner',bindings:[]}}},agents:[{id:'a'}]};
