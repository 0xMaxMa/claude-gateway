...
async function runScenario(runner,scenario,fault,inference){
 ...
 const binding={version:1,id:'fixture-tab',name:'Mock browser',principalId:'owner',conversationId:accepted.conversationId,
  ...
  run:c=>runner.runBrowserTask({goal:c.goal,scope:{device_id:'fixture-device',grant_id:'fixture-grant',tab_id:'fixture-tab'},fields:c.fields??[],maxSteps:10,maxEvaluations:15,timeoutMs:30000},{call,evaluate:r=>c.evaluate(r,c.signal)},c.signal)};
