...
.status-badge{display:inline-flex;align-items:center;justify-content:center;box-sizing:border-box;max-width:100%;min-height:28px;padding:4px 10px;border-radius:8px;font-size:12px;font-weight:600;line-height:18px;letter-spacing:0;white-space:normal;text-align:center;vertical-align:middle;color:var(--status-color);background:color-mix(in srgb,var(--status-color) 12%,var(--panel));border:1px solid color-mix(in srgb,var(--status-color) 28%,var(--line))}
