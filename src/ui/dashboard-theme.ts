...
.reuse-column-plot{height:244px}.reuse-date{position:absolute;top:188px;left:50%;transform:translateX(-50%);font-size:10px;color:var(--muted);white-space:nowrap;pointer-events:none}.reuse-plot-body{flex:1;min-width:0;overflow-x:auto;overflow-y:hidden;padding-bottom:4px}.reuse-timeline{width:100%;padding-bottom:28px}.reuse-columns{display:flex;height:180px;border-bottom:1px solid var(--line);background:repeating-linear-gradient(to top,transparent 0,transparent 88px,var(--line) 89px,transparent 90px)}
.reuse-column{flex:1;min-width:24px;position:relative;outline-offset:-2px}.reuse-hit{width:16px;margin:0 auto;height:180px;display:flex;align-items:flex-end}.reuse-stack{width:16px;display:flex;flex-direction:column-reverse;border-radius:3px 3px 0 0;overflow:hidden}.reuse-stack>span{width:100%;flex-shrink:0}
.reuse-hit:hover~.chart-popover,.reuse-column:focus-visible>.chart-popover{display:block}.reuse-column>.chart-popover{left:50%;transform:translateX(-50%);top:4px;font-size:11px;line-height:1.6}.reuse-column:first-child>.chart-popover{left:0;transform:none}.reuse-column:last-child>.chart-popover{left:auto;right:0;transform:none}
