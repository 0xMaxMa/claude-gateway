...
.chart-hit:hover .chart-popover,.chart-hit:focus-visible .chart-popover,.agent-column:hover .chart-popover,.agent-column:focus-visible .chart-popover{display:block}
...
.agent-column{--agent-chart-color:hsl(var(--agent-hue) 55% 52%);min-width:0;flex:1;text-align:center;position:relative;outline-offset:3px}.agent-bar-space{height:180px;display:flex;justify-content:center;align-items:flex-end}
...
.agent-column>.chart-popover{left:50%;transform:translateX(-50%);top:4px}.agent-column:first-child>.chart-popover{left:0;transform:none}.agent-column:last-child>.chart-popover{left:auto;right:0;transform:none}.agent-bar-label{display:flex;align-items:center;justify-content:center;gap:5px;padding:0 4px;margin-top:10px;min-width:0;font-size:11px;color:var(--muted)}.agent-bar-label>i{width:6px;height:6px;flex:none;border-radius:50%;background:var(--agent-chart-color)}.agent-bar-label>span{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}

.model-donut-layout{display:flex;gap:20px;align-items:center;min-height:230px}.model-donut{position:relative;width:190px;flex:0 0 190px}.model-donut svg{display:block;width:100%;height:auto}.model-donut circle:hover,.model-donut circle:focus{filter:brightness(.82);outline:none}
...
.reuse-headline{display:flex;align-items:center;gap:20px;margin:16px 0 24px}.reuse-headline>strong{font-size:44px;line-height:1.2;font-weight:550;color:var(--token-agent);letter-spacing:-1px;white-space:nowrap}.reuse-headline strong small{font-size:23px}.reuse-headline>div{font-size:13px}.reuse-headline>div>span{display:block;color:var(--muted);font-size:11px;margin-top:4px}
