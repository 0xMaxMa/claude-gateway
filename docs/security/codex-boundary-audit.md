...
| Provider credentials | Only selected portable native API-key/provider settings enter the worker's private home/environment. OAuth/keyring refresh state is not copied. Credentials are not placed in command arguments. |
