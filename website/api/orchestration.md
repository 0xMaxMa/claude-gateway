...
Unreadable journal records are retained for operator inspection with a bounded diagnostic. A damaged retry record blocks only its identifiable conversation until repaired; it does not silently discard messages or block other conversations.
